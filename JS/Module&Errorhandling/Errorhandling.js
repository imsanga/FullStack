...
let couponcodestatus = (couponcode) => {
    ...
    else console.log(`Your entered coupon code ${couponcode} is activated, Enjoy Prime Subscription!!!`);
}
...
let couponcodestatus1 = (couponcode1) => {
    ...
    else return `Your entered coupon code ${couponcode1} is activated, Enjoy Prime Subscription!!!`;
    }
    catch(err){
        return err;
    }
